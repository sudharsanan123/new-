...
public class TeacherService {
    ...
    // New method to get the logged-in teacher's details
    @PreAuthorize("hasRole('TEACHER')")
    public Teacher getLoggedTeacher(String username) {
        logger.debug("Fetching logged-in teacher: {}", username);
        Teacher teacher = findTeacherByUsername(username);
        if (teacher == null) {
            logger.warn("Logged-in teacher not found: {}", username);
