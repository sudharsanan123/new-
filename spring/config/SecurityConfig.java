    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        return http.csrf(csrf -> csrf.disable())
            .authorizeHttpRequests(requests -> requests
                ...
                .requestMatchers("/users/login", "/error", "/users/login/teacher", "/users/registerManagement", "/users/registerTeacher").permitAll()
                ...
                .requestMatchers(HttpMethod.GET, "/students").hasAnyAuthority("MANAGEMENT", "TEACHER", "STUDENT") // All roles can view students
                ...
                .requestMatchers(HttpMethod.POST, "/teachers/**").hasAuthority("MANAGEMENT") // Only management can add teachers
                .requestMatchers(HttpMethod.GET, "/teachers/").hasAuthority("MANAGEMENT") // Both management and teachers can view teachers
                .requestMatchers(HttpMethod.GET, "/teachers/me").hasAuthority("TEACHER") // Allow access to TEACHER without ROLE_ prefix
    
                .requestMatchers(HttpMethod.PUT, "/teachers/**").hasAnyAuthority("MANAGEMENT", "TEACHER") // Both management and teachers can update teachers
                .requestMatchers(HttpMethod.DELETE, "/teachers/**").hasAuthority("MANAGEMENT") // Only management can delete teachers
