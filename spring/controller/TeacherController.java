...
public class TeacherController {
    ...
    @GetMapping("/me")
    @PreAuthorize("hasRole('TEACHER')") // Allows only TEACHER role
    ...
    @PutMapping("/{id}")
    @PreAuthorize("hasAnyRole('MANAGEMENT', 'TEACHER')") // Allows MANAGEMENT and TEACHER roles
    ...
    @DeleteMapping("/{id}")
    @PreAuthorize("hasRole('MANAGEMENT')") // Allows only MANAGEMENT role
